      ...
      <section className="page-hero page-hero-soft-bottom grain text-white">
        <div className="container-page relative z-10">
          ...
          <a
            ...
            className="mt-8 inline-flex min-h-11 items-center justify-center rounded-full border border-white/30 bg-white px-4 py-2 text-sm font-semibold text-brand-deep transition-colors hover:bg-brand-soft"
          >
            Follow on LinkedIn
          </a>
        </div>
